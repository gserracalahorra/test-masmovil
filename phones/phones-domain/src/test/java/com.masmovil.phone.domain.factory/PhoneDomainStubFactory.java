package com.masmovil.phone.domain.factory;
...
public class PhoneDomainStubFactory {

    public static List<Phone> createValidPhoneList() {
    ...
    public static Phone buildPhone(Long id, String name, String description, String imagePath, BigDecimal price) {
        return new Phone(id, name, description, imagePath, price);
    }

    public static List<Phone> createEmptyList() {
